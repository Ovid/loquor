...
// Exported so the lexicon index (src/llm/lexicon/index.ts) can key the
// per-game noun lexicons by the same signatures.
export const ZORK1_SIG =
  '030000774b5450d5389903e602b02c12004038383034323901f0a99bbf44'
export const ZORK2_SIG =
  '0300003f4d6c4de53a8e02a823132df7000038363038313101e8b4b64492'
export const ZORK3_SIG =
  '030000194dfa6cf73d8b02ae1fd23104000038363038313101eeabd8f645'
